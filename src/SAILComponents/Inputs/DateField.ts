import { booleanProp } from "../../typeguards"
...
export const isDateFieldInstance = async (instanceNode: InstanceNode): Promise<boolean> => {
    ...
    return nodeMainComponentName === 'Date & Time' && showTime === false
}
